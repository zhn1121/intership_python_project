...
class PowerUp:
    # ... (This class is unchanged from the previous version)
    PROPERTIES = {
        'grow': {'color': (60, 60, 255), 'message': 'PADDLE GROW', 'char': 'G'},
        'laser': {'color': (255, 60, 60), 'message': 'LASER CANNONS', 'char': 'L'},
        'glue': {'color': (60, 255, 60), 'message': 'CATCH PADDLE', 'char': 'U'},
        'slow': {'color': (255, 165, 0), 'message': 'SLOW BALL', 'char': 'S'},
        'shrink': {'color': (128, 0, 128), 'message': 'Paddle Shrunk!', 'char': 'H'},
        'extra_life': {'color': (0, 255, 255), 'message': 'Extra Life!', 'char': '+'},
    }
